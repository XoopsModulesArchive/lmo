                ...
                <form name="lmoedit" action="<?php echo $PHP_SELF; ?>" method="post" onSubmit="return chklmopass()">
                    ...
                    <tr>
                        <td class="lmost4" colspan="3">
                            <nobr><?php echo $text[423]; ?></nobr>
                        </td>
                    </tr>
                    <tr>
                        <td class="lmost5" width="20">&nbsp;</td>
                        <td class="lmost5" align="right">
                            <nobr><acronym title="<?php echo $text[425] ?>"><?php echo $text[424]; ?></acronym></nobr>
                        </td>
                        <td class="lmost5"><acronym title="<?php echo $text[425] ?>"><input class="lmoadminein" type="text" name="xtababack" size="7" maxlength="7" value="<?php echo $stylearr['TABLE.lmomaina']['background']; ?>" onChange="dolmoedit()"></acronym>&nbsp;<acronym
                                    title="<?php echo $text[433] ?>"><input class="lmoadminein" type="text" name="xtabacolo" size="7" maxlength="7" value="<?php echo $stylearr['TD.lmomain1']['color']; ?>" onChange="dolmoedit()"></acronym></td>
                    </tr>
                    <tr>
                        <td class="lmost5" width="20">&nbsp;</td>
                        <td class="lmost5" align="right">
                            <nobr><acronym title="<?php echo $text[427] ?>"><?php echo $text[426]; ?></acronym></nobr>
                        </td>
                    ...
                    <tr>
                        <td class="lmost5" width="20">&nbsp;</td>
                        <td class="lmost5" align="right">
                            <nobr><acronym title="<?php echo $text[429] ?>"><?php echo $text[428]; ?></acronym></nobr>
                        </td>
                    ...
                    <tr>
                        <td class="lmost5" width="20">&nbsp;</td>
                        <td class="lmost5" align="right">
                            <nobr><acronym title="<?php echo $text[431] ?>"><?php echo $text[430]; ?></acronym></nobr>
                        </td>
                        <td class="lmost5"><acronym title="<?php echo $text[431] ?>"><input class="lmoadminein" type="text" name="xtabasize" size="6" maxlength="6" value="<?php echo $stylearr['TD.lmomain1']['font-size']; ?>" onChange="dolmoedit()"></acronym>&nbsp;<acronym
                                    title="<?php echo $text[434] ?>"><input class="lmoadminein" type="text" name="xtabatite" size="6" maxlength="6" value="<?php echo $stylearr['TD.lmomain0']['font-size']; ?>" onChange="dolmoedit()"></acronym>&nbsp;<acronym title="<?php echo $text[435] ?>"><input
                                        class="lmoadminein" type="text" name="xtabaupda" size="6" maxlength="6" value="<?php echo $stylearr['TD.lmomain2']['font-size']; ?>" onChange="dolmoedit()"></acronym></td>
                    </tr>
                    <tr>
                        <td class="lmost5" width="20">&nbsp;</td>
                        <td class="lmost5" align="right">
                            <nobr><acronym title="<?php echo $text[440] ?>"><?php echo $text[439]; ?></acronym></nobr>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="lmost5"><acronym title="<?php echo $text[425] ?>"><input class="lmoadminein" type="text" name="xtabbback" size="7" maxlength="7" value="<?php echo $stylearr['TABLE.lmosta']['background']; ?>" onChange="dolmoedit()"></acronym>&nbsp;<acronym
                                    title="<?php echo $text[433] ?>"><input class="lmoadminein" type="text" name="xtabbcolo" size="7" maxlength="7" value="<?php echo $stylearr['TD.lmost1']['color']; ?>" onChange="dolmoedit()"></acronym></td>
                    </tr>
                    <tr>
                        <td class="lmost5" width="20">&nbsp;</td>
                        <td class="lmost5" align="right">
                    ...
                    <tr>
                        <td class="lmost5" width="20">&nbsp;</td>
                        <td class="lmost5" align="right">
                            <nobr><acronym title="<?php echo $text[438] ?>"><?php echo $text[437]; ?></acronym></nobr>
                        </td>
                    ...
                    <tr>
                        <td class="lmost4" colspan="3">
                            <nobr><?php echo $text[441]; ?></nobr>
                        </td>
                    </tr>
                    <tr>
                        <td class="lmost5" width="20">&nbsp;</td>
                        <td class="lmost5" align="right">
                            <nobr><acronym title="<?php echo $text[425] ?>"><?php echo $text[442]; ?></acronym></nobr>
                        </td>
                        <td class="lmost5"><acronym title="<?php echo $text[425] ?>"><input class="lmoadminein" type="text" name="xtabcback" size="7" maxlength="7" value="<?php echo $stylearr['TABLE.lmostb']['background']; ?>" onChange="dolmoedit()"></acronym>&nbsp;<acronym
                                    title="<?php echo $text[443] ?>"><input class="lmoadminein" type="text" name="xtabcgrey" size="7" maxlength="7" value="<?php echo $stylearr['TD.lmost4']['background']; ?>" onChange="dolmoedit()"></acronym>&nbsp;<acronym title="<?php echo $text[433] ?>"><input
                                        class="lmoadminein" type="text" name="xtabccolo" size="7" maxlength="7" value="<?php echo $stylearr['TD.lmost5']['color']; ?>" onChange="dolmoedit()"></acronym></td>
                    </tr>
                    <tr>
                        <td class="lmost5" width="20">&nbsp;</td>
                        <td class="lmost5" align="right">
                    ...
                    <tr>
                        <td class="lmost5" width="20">&nbsp;</td>
                        <td class="lmost5" align="right">
                            <nobr><acronym title="<?php echo $text[445] ?>"><?php echo $text[444]; ?></acronym></nobr>
                        </td>
                        <td class="lmost5"><acronym title="<?php echo $text[445] ?>"><input class="lmoadminein" type="text" name="xtabclin1" size="7" maxlength="7" value="<?php echo $stylearr['TD.lmost5 a:link']['color']; ?>" onChange="dolmoedit()"></acronym>&nbsp;<acronym
                                    title="<?php echo $text[446] ?>"><input class="lmoadminein" type="text" name="xtabclin2" size="7" maxlength="7" value="<?php echo $stylearr['TD.lmost5 a:hover']['color']; ?>" onChange="dolmoedit()"></acronym></td>
                    </tr>
                    <tr>
                        <td class="lmost8" colspan="3">
                            <nobr><?php echo $text[450]; ?></nobr>
                        </td>
                    </tr>
                    <tr>
                        <td class="lmost5" width="20">&nbsp;</td>
                        <td class="lmost5" align="right">
                            <nobr><acronym title="<?php echo $text[425] ?>"><?php echo $text[451]; ?></acronym></nobr>
                        </td>
                    ...
                    <tr>
                        <td class="lmost5" width="20">&nbsp;</td>
                        <td class="lmost5" align="right">
                            <nobr><acronym title="<?php echo $text[425] ?>"><?php echo $text[452]; ?></acronym></nobr>
                        </td>
                    ...
                    <tr>
                        <td class="lmost5" width="20">&nbsp;</td>
                        <td class="lmost5" align="right">
                            <nobr><acronym title="<?php echo $text[425] ?>"><?php echo $text[453]; ?></acronym></nobr>
                        </td>
                    ...
                    <tr>
                        <td class="lmost5" width="20">&nbsp;</td>
                        <td class="lmost5" align="right">
                            <nobr><acronym title="<?php echo $text[425] ?>"><?php echo $text[454]; ?></acronym></nobr>
                        </td>
                    ...
                    <tr>
                        <td class="lmost5" width="20">&nbsp;</td>
                        <td class="lmost5" align="right">
                            <nobr><acronym title="<?php echo $text[425] ?>"><?php echo $text[455]; ?></acronym></nobr>
                        </td>
                    ...
                    <tr>
                        <td class="lmost5" width="20">&nbsp;</td>
                        <td class="lmost5" align="right">
                            <nobr><acronym title="<?php echo $text[425] ?>"><?php echo $text[456]; ?></acronym></nobr>
                        </td>
                    ...
                    <tr>
                        <td class="lmost5" width="20">&nbsp;</td>
                        <td class="lmost5" align="right">
                            <nobr><acronym title="<?php echo $text[425] ?>"><?php echo $text[457]; ?></acronym></nobr>
                        </td>
                    ...
                    <tr>
                        <td class="lmost5" width="20">&nbsp;</td>
                        <td class="lmost5" align="right">
                            <nobr><acronym title="<?php echo $text[425] ?>"><?php echo $text[458]; ?></acronym></nobr>
                        </td>
                    ...
                    <tr>
                        <td class="lmost8" colspan="3">
                            <nobr><?php echo $text[459]; ?></nobr>
                        </td>
                    </tr>
                    <tr>
                        <td class="lmost5" width="20">&nbsp;</td>
                        <td class="lmost5" align="right">
                            <nobr><acronym title="<?php echo $text[425] ?>"><?php echo $text[460]; ?></acronym></nobr>
                        </td>
                    ...
                    <tr>
                        <td class="lmost5" width="20">&nbsp;</td>
                        <td class="lmost5" align="right">
                            <nobr><acronym title="<?php echo $text[425] ?>"><?php echo $text[461]; ?></acronym></nobr>
                        </td>
                    ...
                    <tr>
                        <td class="lmost5" width="20">&nbsp;</td>
                        <td class="lmost5" align="right">
                            <nobr><acronym title="<?php echo $text[425] ?>"><?php echo $text[462]; ?></acronym></nobr>
                        </td>
                    ...
                    <tr>
                        <td class="lmost5" width="20">&nbsp;</td>
                        <td class="lmost5" align="right">
                            <nobr><acronym title="<?php echo $text[425] ?>"><?php echo $text[463]; ?></acronym></nobr>
                        </td>
                    ...
                    <tr>
                        <td class="lmost8" colspan="3">
                            <nobr><?php echo $text[464]; ?></nobr>
                        </td>
                    </tr>
                    <tr>
                        <td class="lmost5" width="20">&nbsp;</td>
                        <td class="lmost5" align="right">
                            <nobr><acronym title="<?php echo $text[425] ?>"><?php echo $text[465]; ?></acronym></nobr>
                        </td>
                    ...
                    <tr>
                        <td class="lmost5" width="20">&nbsp;</td>
                        <td class="lmost5" align="right">
                            <nobr><acronym title="<?php echo $text[433] ?>"><?php echo $text[466]; ?></acronym></nobr>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="lmost5"><acronym title="<?php echo $text[425] ?>"><input class="lmoadminein" type="text" name="xtabtback" size="7" maxlength="7" value="<?php echo $stylearr['INPUT.lmotickerein']['background']; ?>" onChange="dolmoedit()"></acronym>&nbsp;<acronym
                                    title="<?php echo $text[433] ?>"><input class="lmoadminein" type="text" name="xtabtcolo" size="7" maxlength="7" value="<?php echo $stylearr['INPUT.lmotickerein']['color']; ?>" onChange="dolmoedit()"></acronym></td>
                    </tr>
                    <tr>
                        <td class="lmost5" width="20">&nbsp;</td>
                        <td class="lmost5" align="right">
                    ...
                    <tr>
                        ...
                        <td class="lmost5"><acronym title="<?php echo $text[425] ?>"><input class="lmoadminein" type="text" name="xtabeback" size="7" maxlength="7" value="<?php echo $stylearr['INPUT.lmoadminein']['background']; ?>" onChange="dolmoedit()"></acronym>&nbsp;<acronym
                                    title="<?php echo $text[433] ?>"><input class="lmoadminein" type="text" name="xtabecolo" size="7" maxlength="7" value="<?php echo $stylearr['INPUT.lmoadminein']['color']; ?>" onChange="dolmoedit()"></acronym></td>
                    </tr>
                    <tr>
                        <td class="lmost8" colspan="3">
                            <nobr><?php echo $text[449]; ?></nobr>
                        </td>
                    </tr>
                    <tr>
                        <td class="lmost5" width="20">&nbsp;</td>
                        ...
                        <td class="lmost5"><acronym title="<?php echo $text[425] ?>"><input class="lmoadminein" type="text" name="xtabkback" size="7" maxlength="7" value="<?php echo $stylearr['INPUT.lmoadminbut']['background']; ?>" onChange="dolmoedit()"></acronym>&nbsp;<acronym
                                    title="<?php echo $text[433] ?>"><input class="lmoadminein" type="text" name="xtabkcolo" size="7" maxlength="7" value="<?php echo $stylearr['INPUT.lmoadminbut']['color']; ?>" onChange="dolmoedit()"></acronym></td>
                    </tr>
                    <tr>
