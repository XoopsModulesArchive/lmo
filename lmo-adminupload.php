...
if (('admin' == $action) && ('upload' == $todo) && (2 == $HTTP_SESSION_VARS['lmouserok'])) {
    ...
    if ((1 == $upl) && ('' != $userfile)) {
        ...
        while (file_exists($ufile)) {
            ...
            if ($i > 0) {
                $ufile = $dirliga . $userfile_name . '_' . $i;
            } else {
                $ufile = $dirliga . $userfile_name;
            }
        }
        ...
        if (move_uploaded_file($userfile, $ufile)) {
            echo '<font color="#008800">' . $text[303] . ':<br>' . $ufile . '</font>';
        } else {
            echo '<font color="#ff0000">' . $text[304] . '</font>';
        }
    } ?>
                ...
                <table width="100%" class="lmostb" cellspacing="0" cellpadding="0" border="0">
                    <tr>
                        <td class="lmost5" align="center">
                            <acronym title="<?php echo $text[302] ?>">
                                <nobr>
