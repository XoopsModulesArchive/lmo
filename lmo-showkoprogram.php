                            ...
                            for ($i = 0; $i < (($anzteams / 2) + 1); $i++) {
                                if (($selteam == $teama[$j][$i]) || ($selteam == $teamb[$j][$i])) {
                                    ...
                                    <tr>
                                        ...
                                        <?php
                                        $m1 = [$goala[$j][$i][0], $goala[$j][$i][1], $goala[$j][$i][2], $goala[$j][$i][3], $goala[$j][$i][4], $goala[$j][$i][5], $goala[$j][$i][6]];

                                    $m2 = [$goalb[$j][$i][0], $goalb[$j][$i][1], $goalb[$j][$i][2], $goalb[$j][$i][3], $goalb[$j][$i][4], $goalb[$j][$i][5], $goalb[$j][$i][6]];
                                    ...
                                    if ($selteam == $teamb[$j][$i]) {
                                        ...
                                        for ($n = 0; $n < $modus[$j]; $n++) {
                                            ...
                                            <td class="lmost5"><?php echo $dumn1; ?><?php echo $goala[$j][$i][$n]; ?>&nbsp;:&nbsp;<?php echo $goalb[$j][$i][$n]; ?>&nbsp;<?php echo $mspez[$j][$i][$n]; ?><?php echo $dumn2; ?>
                                                ...
                                                if (1 == $urlb) {
                                                    if ('' != $mberi[$j][$i][$n]) {
                                                        echo '<a href="' . $mberi[$j][$i][$n] . '" target="_blank" title="' . $text[270] . '"><img src="lmo-st1.gif" width="16" height="16" border="0"></a>';
                                                    } else {
                                                        echo '&nbsp;';
                                                    }
                                                }
