...
if ('' != $file) {
    ...
    if ('.l98' == mb_substr($file, -4)) {
            ...
            if (('[' == mb_substr($zeile, 0, 1)) && (']' == mb_substr($zeile, -1))) {
                ...
                if ('Options' == $sekt) {
                    ...
                    if (0 == $lmtype) {
                        ...
                        if ('PointsForWin' == $schl) {
                            $pns = $wert;
                        }

                        if ('PointsForDraw' == $schl) {
                            $pnu = $wert;
                        }

                        if ('PointsForLost' == $schl) {
                            $pnn = $wert;
                        }
        ...
        if (0 == $lmtype) {
            $strafp = array_pad(['0'], 116, '0');

            $strafm = array_pad(['0'], 116, '0');

            $handp = array_pad(['0'], 116, '0');
        ...
        for ($i = 1, $iMax = count($daten); $i <= $iMax; $i++) {
            ...
            if (0 == $lmtype) {
                if (('Team' == $op1) && ('Teams' != $dum[0]) && ('Teamk' != $dum[0]) && ('SP' == $dum[1])) {
                    $strafp[$op5] = $dum[2];
                }

                if (('Team' == $op1) && ('Teams' != $dum[0]) && ('Teamk' != $dum[0]) && ('SM' == $dum[1])) {
                    $strafm[$op5] = $dum[2];
                }
            }
